...
trying to improve nftables performance in kernels with REPTOLINE mitigations enabled. He commented that several
...
MB/s and PPS. The flowtable infrastructure is specially benefited from this approach, but Pablo suggested rerunning
the tests without conntrack enabled.
